...
def tune_by_cross_validation(
    ...
    for i in range(num_folds):
        ...
        train_df, tune_df = split_train_test(
            ...
            df=label_pairs_metal_type(df_pairs=train_df, df_anno=df_anno),
            id=['seq_id'],
        ...
        valid_result_df['pred'] = predictor.predict(valid_data_df, as_pandas=False)
...
def filter_cross_validation_results(
    ...
    result = calc_metrics_for_pairs_metal_type(df_anno, valid_result_all_df)
    logging.debug("Done.")
